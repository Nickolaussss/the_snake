...
class Snake(GameObject):
    ...
    def move(self) -> None:
        ...
        x_step = self.direction[0] * GRID_SIZE
        y_step = self.direction[1] * GRID_SIZE
        new_head = ((head_x + x_step) % SCREEN_WIDTH,
                    (head_y + y_step) % SCREEN_HEIGHT)
